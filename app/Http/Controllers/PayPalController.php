...
/**
 * Ex. https://quickadminpanel.com/blog/paypal-payments-in-laravel-the-ultimate-guide/
 *
...
//        $response = $provider->setExpressCheckout($this->checkoutData());
//
//        return redirect($response['paypal_link']);
//    }
//
...
//            $cartItems[$key]['name'] = $item->product->title;
//            $cartItems[$key]['price'] = $item->total;
//            $cartItems[$key]['qty'] = $item->quantity;
//        }
//
//        $checkoutData = [
//            'items' => $cartItems,
