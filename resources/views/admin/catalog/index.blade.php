            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a href="{{ url('admin/catalog/create') }}" class="btn btn-sm btn-primary">{{ __('Create catalog') }}</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <td>
                                        ...
                                        @if(empty($catalog->deleted_at))
                                            <button type="submit"
                                                    ...
                                                    data-url="{{ url('/admin/catalog/destroy') }}"
                                                    data-title="Are you sure you want to remove this catalog?"
