                                ...
                                @foreach(config('app.locales') as $key => $locale)
                                    <div class="card-body switch-translatable-fields p-0 d-none {{ $locale }}-form @if($key == 0) d-block @endif">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error($locale.'.short_description') is-invalid @enderror" type="text" name="{{ $locale }}[short_description]" id="{{ $locale }}_short_description" value="{{ old($locale.'.short_description') }}">
