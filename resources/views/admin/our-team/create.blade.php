                                ...
                                <ul class="nav nav-tabs translatable-switcher mb-4">
                                    @foreach(config('app.locales') as $key => $locale)
                                        <li class="nav-item">
                                            ...
                                            @error($locale.'.description') text-danger @enderror
                                                " href="javascript:void(0);" data-locale="{{ $locale }}">
                                ...
                                @foreach(config('app.locales') as $key => $locale)
                                    <div class="card-body switch-translatable-fields p-0 d-none {{ $locale }}-form @if($key == 0) d-block @endif">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error($locale.'.last_name') is-invalid @enderror" type="text" name="{{ $locale }}[last_name]" id="{{ $locale }}_last_name" value="{{ old($locale.'.last_name') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error($locale.'.position') is-invalid @enderror" type="text" name="{{ $locale }}[position]" id="{{ $locale }}_position" value="{{ old($locale.'.position') }}">
