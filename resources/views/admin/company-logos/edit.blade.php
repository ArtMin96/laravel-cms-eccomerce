...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('admin.company-logos.update', $companyLogos->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="images">
                                @if(!empty($companyLogos->icon))
                                    ...
                                    <div class="img editable">
                                        <img src="{{ asset('storage/company-logos/'.$companyLogos->icon) }}" alt="Company Logo">
                                        <span class="remove-pic result_file"
                                              data-file-id="{{ $companyLogos->id }}"
                                              data-file-url="{{ LaravelLocalization::localizeUrl('/admin/request/remove-company-logo-image') }}"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('url') is-invalid @enderror" type="text" name="url" id="url" value="{{ old('url', $companyLogos->url) }}">
