...
@section('content')
    ...
    <div class="container">
        ...
        <section>
            <div class="mb-5">
                <h2 class="g-title text-center">{{ __('pages.Apply for job') }}</h2>
            </div>
            <div class="row">
                                    ...
                                    <div class="g-tag-btn">
                                        <div class="g-tag-btn-body">
                                            ...
                                            <div class="g-tag-btn-button">
                                                <button class="g-btn g-btn-green g-btn-round" type="button" data-toggle="collapse" data-target="#collapse-{{ $job->id }}" aria-expanded="false" aria-controls="collapse-{{ $job->id }}">{{ __('pages.Apply') }}</button>
                                            </div>
                                        </div>
                                    </div>
