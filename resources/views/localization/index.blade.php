    ...
    <div class="container">
        ...
        <section class="py-5">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="{{ LaravelLocalization::localizeUrl('/localization') }}" class="g-card-simple g-card-simple-3 g-card-simple-3-active g-card-wrap">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group g-form-group">
                            ...
                            <input type="text" class="form-control g-form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" aria-describedby="surnameHelp" required>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group g-form-group">
                            ...
                            <input type="text" class="form-control g-form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name" value="{{ old('last_name') }}" aria-describedby="surnameHelp" required>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group g-form-group">
                                    <label for="project-file-input">{{ __('forms.Project file') }}</label>
                                    <label class="g-type-file g-type-file-1 form-control g-form-control pt-3">
                                        <input type="file" id="project-file-input" aria-describedby="projectFileHelp">{{ __('forms.select file') }} <i class="fas fa-upload"></i>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-2 p-0">
                                <div class="form-middle-text"><span>{{ __('forms.or / and') }}</span></div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group g-form-group">
                                    <label for="project-file-link-input">{{ __('forms.Project link') }}</label>
                                    <input type="url" class="form-control g-form-control" id="project-file-link-input" aria-describedby="projectFileLinkHelp">
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group g-form-group-sm">
                                                    <div class="d-flex align-items-center">
                                                        <label for="duration-1-input" class="duration-day-label">{{ __('forms.Day') }}<span class="duration-form-day-count ml-1">1</span></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group g-form-group-sm duration-responsive-col">
                                                    <select class="form-control g-form-control g-form-control-sm selectpicker" id="duration-1-select" aria-describedby="fieldInterpretationHelp">
                                                        <option value="full day">{{ __('forms.Full day') }}</option>
                                                        <option value="half day">{{ __('forms.Half day') }}</option>
                                                        <option value="hour">{{ __('forms.Hour') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
