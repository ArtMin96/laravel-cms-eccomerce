            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-3 text-center">
                        <a href="{{ route('login') }}" class="g-btn g-link g-link-2 text-capitalize">{{ __('Login') }}</a>
                        <a href="{{ route('register') }}" class="g-btn g-link g-link-2 text-capitalize green-color">{{ __('Sign Up') }}</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="list-group flex-column justify-content-center flex-sm-row mb-2" id="list-tab" role="tablist">
                                    <a class="list-group-item list-group-item-action g-btn g-btn-white mx-3 mb-3" id="list-1-list" data-toggle="list" href="#list-1" role="tab" aria-controls="home">Physical person</a>
                                    <a class="list-group-item list-group-item-action g-btn g-btn-white mx-3 mb-3" id="list-2-list" data-toggle="list" href="#list-2" role="tab" aria-controls="profile">Legal person</a>
                                </div>
                            </div>
                            <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group g-form-group mb-0 text-center">
                                                        <button type="submit" class="g-btn g-btn-blue g-btn-round text-uppercase">{{ __('Sign Up') }}</button>
                                                    </div>
                                                </div>
